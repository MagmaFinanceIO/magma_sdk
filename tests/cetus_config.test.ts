...
describe('Config Module', () => {
  ...
  test('getTokenListByCoinTypes', async () => {
    const tokenMap = await sdk.MagmaConfig.getTokenListByCoinTypes([
  ...
  test('getCoinConfigs', async () => {
    const coin_list = await sdk.MagmaConfig.getCoinConfigs(true)
    console.log('coin_list: ', coin_list)
  })

  test('getClmmPoolConfigs', async () => {
    const pool_list = await sdk.MagmaConfig.getClmmPoolConfigs()
    console.log('pool_list: ', pool_list)
  })

  test('getLaunchpadPoolConfigs', async () => {
    const pool_list = await sdk.MagmaConfig.getLaunchpadPoolConfigs()
    console.log('pool_list: ', pool_list)
  })
})
